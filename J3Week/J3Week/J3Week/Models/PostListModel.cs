...
namespace J3Week.Models
{
    public class PostListModel
    {
        ...
        List<Image> Animaions = new List<Image>();
        ...
        public static void AddPost(Post NewPost)
        {
            ...
            Debug.WriteLine("Done Add Post");
        }

        public static void getLenPost()
        {
            Debug.WriteLine("Length: ");
            
            Debug.WriteLine(instance.AllPosts.Count);
        }
        ...
        {
            List<FormsUser> Users = TemplateData.Users;
        ...
        void PopulateFilterPreferences(List<Location> Locations, List<FormsUser> Users)
        {
        ...
        {
            if (ExpectedState == PostState.Unliked) // The home page should show both liked and unliked
            {
                return true;
            }
            else
        ...
        public void PostActionFromGrid(object TheGrid)
        {
            ...
            Image LikeIcon = CellGrid.FindByName<Image>("LikeIcon");
        ...
        public void PostActionFromButton(object TheButton)
        {
            ...
            Image LikeIcon = (Image)TheButton;
        ...
        async void AnimatePostAction(Image LikeIcon)
        {
